...
Ropebwt3 can also find maximal exact matches and enumerate suboptimal inexact alignments with affine-gap penalties.
It demonstrates the feasibility of full-text indexing at terabase scale.
\vspace{0.5em}\\
...
Given two strings $T$ and $P$, we can align $G_T$ and $G_P$ under affine-gap penalty
