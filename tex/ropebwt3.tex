...
\item[$^{4}$] 320 long-read human assemblies
...
human100       & grlBWT        &  8.3 h       &  29.6 h &  84.8 GB \\
			   ...
			   & fulgor$^4$    & 1.2 h        &  32.7 h & 165.2 GB \\
...
To test scalability, we indexed a larger dataset consisting of 320 human genomes.
grlBWT is over three times as fast as ropebwt3 but uses more memory (Table~\ref{tab:index}).
