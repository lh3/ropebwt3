...
human472$^5$       & 1421.2 Gb &  39.1 k & 540.5 \\
CommonBacteria$^6$ & 7326.6 Gb & 278.4 M & 828.6 \\
\botrule
\end{tabular*}
...
\item[$^{3}$] 100 long-read human assemblies; N50 string length: 39.9 Mb
\item[$^{4}$] 320 long-read human assemblies; N50 string length: 135.3 Mb
\item[$^{5}$] 472 long-read human assemblies; N50 string length: 135.5 Mb
\item[$^{6}$] AllTheBacteria~\citep{Hunt2024.03.08.584059} excluding ``dustbin'' and ``unknown''
\end{tablenotes}
\end{table}
